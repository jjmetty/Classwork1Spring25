...
public class Controller implements Initializable
{
    ...
    //puts the firstname in the textfields in the UI
    //also puts last name in the text fields
    //is active checkbox whether or not are employed
    @Override
